...
# bgr
img = cv2.imread('Scikit.Image/Rei.jpg')

# rgb
Rei = cv2.cvtColor(img, cv2.COLOR_BGR2RGB)
...
plt.subplot(121), plt.imshow(Rei), plt.title('Original')
...
# memanggil citra sebagai grayscale (argument 0)
img = cv2.imread('Scikit.Image/foto2.jpg', 0)
...
# menampilkan hasil
titles = ['Gambar asli', 'BINARY', 'BINARY_INV',
